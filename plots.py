...
def show_plots():
    ...
    with col1:
        ...
        for echo in interface_echoes:
            fig1.add_vline(x=echo["time"] * 1e6, line_dash="dot", line_color="red")
            fig1.add_annotation(
                x=echo["time"] * 1e6,
                y=max(rx),
                text=echo["interface"],
    ...
    with col2:
        ...
        for echo in interface_echoes:
            fig2.add_vline(x=echo["time"] * 1e6, line_dash="dot", line_color="red")
            fig2.add_annotation(
                x=echo["time"] * 1e6,
                y=max(rx_aligned),
                text=echo["interface"],
    ...
    with col1:
        ...
        for echo in interface_echoes:
            fig3.add_vline(x=echo["time"] * 1e6, line_dash="dot", line_color="red")
            fig3.add_annotation(
                x=echo["time"] * 1e6,
                y=max(rx_compressed),
                text=echo["interface"],
    ...
    with col2:
        ...
        for echo in interface_echoes:
            fig4.add_vline(x=echo["time"] * 1e6, line_dash="dot", line_color="red")
            fig4.add_annotation(
                x=echo["time"] * 1e6,
                y=max(rx_compressed_aligned),
                text=echo["interface"],
                showarrow=True,
                arrowhead=2,
                yshift=10,
